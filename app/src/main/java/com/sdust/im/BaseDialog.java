...
public class BaseDialog extends Dialog implements
	...
	private void initViews() {
		mLayoutRoot = findViewById(R.id.dialog_generic_layout_root);
		mLayoutTop = findViewById(R.id.dialog_generic_layout_top);
		mLayoutTitle = findViewById(R.id.dialog_generic_layout_title);
		mHtvTitle = findViewById(R.id.dialog_generic_htv_title);
		mViewTitleLine = findViewById(R.id.dialog_generic_view_titleline);
		mLayoutContent = findViewById(R.id.dialog_generic_layout_content);
		mHtvMessage = findViewById(R.id.dialog_generic_htv_message);
		mLayoutBottom = findViewById(R.id.dialog_generic_layout_bottom);
		mBtnButton1 = findViewById(R.id.dialog_generic_btn_button1);
		mBtnButton2 = findViewById(R.id.dialog_generic_btn_button2);
		mBtnButton3 = findViewById(R.id.dialog_generic_btn_button3);
